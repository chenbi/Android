...
public class Hw3Prob5 {
	public static void main(String args[]) {
		...
		if ((args.length < 2) || (args.length > 4)) {
			String errorMessage = "Usage: java Hw3Prob5 forwardingTableFile testIPInputFile [prefixOutputFile] [testIPOutputFile]";
			System.out.println("Error using Hw3Prob5");
	 ...
	 * 
	 * @param testFileName name of the file containing the test IP addresses
