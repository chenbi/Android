...
public class curveGen extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener, ActionListener{
	...
	private void drawBezier() {
		// ***** YOUR WORK HERE *****
		/* computes and draws Bezier curve
		 * the *entire* curve is approximated by nsegment line segments,
		 ...
		 * 
		 * if there are less than 3 control points, return immediately
		 */
	...
	private void drawBspline() {
		// ***** YOUR WORK HERE *****
		/* computes and draws Piecewise Cubic Bspline curve
